...
import com.Omest982.Money_program.Exceptions.AppError;
import com.Omest982.Money_program.dto.JwtResponse;
import com.Omest982.Money_program.dto.UserLoginDTO;
import com.Omest982.Money_program.service.UserService;
import com.Omest982.Money_program.utils.JwtTokenUtils;
...
public class AuthController {
    ...
    @PostMapping("/auth")
    public ResponseEntity<?> createAuthToken(@RequestBody UserLoginDTO authRequest){
        try {
